...
public class WriteBigFileComparison {
    ...
    public static void unmap(final MappedByteBuffer mappedByteBuffer) {
        try {
            ...
            System.out.println("force waste time : " + (System.currentTimeMillis() - startTime) + " ms");
            ...
            System.out.println("doPrivileged waste time : " + (System.currentTimeMillis() - startTime) + " ms");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
